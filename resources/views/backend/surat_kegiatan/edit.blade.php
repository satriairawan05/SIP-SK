...
@section('app')
    ...
    <div class="row mb-3">
        <div class="card col-12">
            ...
            @endif
            <div class="card-body">
                <form action="{{ route('skk.update', $keputusan->skk_id) }}" method="post">
                    @csrf
                    @method('put')
                    <div class="row mb-3">
                        <div class="col-6">
                            ...
                            is-invalid
                        @enderror"
                                name="skk_subject" id="skk_subject" value="{{ old('skk_subject', $keputusan->skk_subject) }}"
                        ...
                        <div class="col-6" id="simple-date">
                            ...
                            is-invalid
                        @enderror"
                                    value="{{ old('skk_tgl_surat', $keputusan->skk_tgl_surat) }}" name="skk_tgl_surat"
                                    id="skk_tgl_surat" required>
                            </div>
                            @error('skk_tgl_surat')
                                <div class="invalid-feedback">
                                    {{ $message }}
                    ...
                    <div class="row mb-3">
                        <div class="col-12">
                            <label for="skk_no_surat">Nomor Surat</label>
                            <input type="text" name="skk_no_surat" id="skk_no_surat" class="form-control form-control-sm" placeholder="Masukan Nomor Surat">
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-6">
                        ...
                        <div class="col-6">
                            ...
                            <textarea class="ckeditor form-control" name="skk_mengingat" id="skk_mengingat" cols="50" rows="10">{{ old('skk_mengingat', $keputusan->skk_mengingat) }}</textarea>
                            @error('skk_mengingat')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-6">
                            ...
                            <textarea class="ckeditor form-control" name="skk_memperhatikan" id="skk_memperhatikan" cols="50" rows="10">{{ old('skk_memperhatikan', $keputusan->skk_memperhatikan) }}</textarea>
                        ...
                        <div class="col-6">
                            ...
                            <textarea class="ckeditor form-control" name="skk_menetapkan" id="skk_menetapkan" cols="50" rows="10">{{ old('skk_menetapkan', $keputusan->skk_menetapkan) }}</textarea>
                    ...
                    <div class="row mb-3">
                        <div class="col-6">
                            ...
                            <textarea class="ckeditor form-control" name="skk_kesatu" id="skk_kesatu" cols="50" rows="10">{{ old('skk_kesatu', $keputusan->skk_kesatu) }}</textarea>
                            @error('skk_kesatu')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="col-6">
                            ...
                            <textarea class="ckeditor form-control" name="skk_kedua" id="skk_kedua" cols="50" rows="10">{{ old('skk_kedua', $keputusan->skk_kedua) }}</textarea>
                            @error('skk_kedua')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-6">
                            ...
                            <textarea class="ckeditor form-control" name="skk_ketiga" id="skk_ketiga" cols="50" rows="10">{{ old('skk_ketiga', $keputusan->skk_ketiga) }}</textarea>
                            @error('skk_ketiga')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="col-6">
                            ...
                            <textarea class="ckeditor form-control" name="skk_keempat" id="skk_keempat" cols="50" rows="10">{{ old('skk_keempat', $keputusan->skk_keempat) }}</textarea>
                            @error('skk_keempat')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
