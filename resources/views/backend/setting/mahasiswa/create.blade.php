            ...
            <form action="{{ route('mahasiswa.store') }}" method="post">
                ...
                <div class="row">
                    <div class="form-group col-6">
                        ...
                        <input type="text" class="form-control form-control-sm @error('mhs_nama')
                            is-invalid
                        @enderror" name="mhs_nama" id="mhs_nama" value="{{ old('mhs_nama') }}" placeholder="Enter name ex: Nana" required>
                        @error('mhs_nama')
                    ...
                    <div class="form-group col-6">
                        ...
                        <input type="text" class="form-control form-control-sm @error('mhs_nim')
                            is-invalid
                        @enderror" name="mhs_nim" id="mhs_nim" value="{{ old('mhs_nim') }}" placeholder="Enter Nim ex: H181######" required>
                        @error('mhs_nim')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="row">
                    <div class="form-group col-6">
                        ...
                        <input type="text" class="form-control form-control-sm @error('mhs_no_hp')
                            is-invalid
                        @enderror" name="mhs_no_hp" id="mhs_no_hp" value="{{ old('mhs_no_hp') }}" placeholder="Enter Phone Number ex: 08##########" required>
                        @error('mhs_no_hp')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                    ...
                    <div class="form-group col-6">
                        ...
                        <input type="text" class="form-control form-control-sm @error('mhs_alamat')
                            is-invalid
                        @enderror" name="mhs_alamat" id="mhs_alamat" value="{{ old('mhs_alamat') }}" placeholder="Enter name ex: Jl. Samratulangi" required>
                        @error('mhs_alamat')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="row">
                    <div class="col-12 d-flex justify-content-center">
                        <a href="{{ route('mahasiswa.index') }}" class="btn btn-sm btn-info mx-2"><i class="fas fa-reply-all"></i></a>
