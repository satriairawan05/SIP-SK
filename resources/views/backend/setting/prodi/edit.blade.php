                ...
                <form action="{{ route('prodi.update', $prodi->prodi_id) }}" method="post">
                    ...
                    <div class="row">
                        <div class="form-group col-6">
                            ...
                            is-invalid
                        @enderror"
                                name="name" id="name" value="{{ old('name', $prodi->prodi_name) }}"
                        ...
                        <div class="form-group col-6">
                            ...
                            is-invalid
                        @enderror"
                                name="alias" id="alias" value="{{ old('alias', $prodi->prodi_alias) }}"
                    ...
                    <div class="row">
                        <div class="form-group col-6">
                            ...
                            is-invalid
                        @enderror"
                                name="jenjang"value="{{ old('jenjang', $prodi->prodi_jenjang) }}" id="jenjang"
                        ...
                        <div class="form-group col-6">
                            ...
                            is-invalid
                        @enderror"
                                name="code"value="{{ old('code', $prodi->prodi_code) }}" id="code"
