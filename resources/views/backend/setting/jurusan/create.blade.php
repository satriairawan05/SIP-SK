                ...
                <form action="{{ route('jurusan.store') }}" method="post">
                    ...
                    <div class="row">
                        <div class="form-group col-12">
                            ...
                            is-invalid
                        @enderror"
                                name="jurusan_nama" id="jurusan_nama" value="{{ old('jurusan_nama') }}"
                    ...
                    <div class="row">
                        <div class="form-group col-12">
                            ...
                            is-invalid
                        @enderror"
                                name="jurusan_alias" id="jurusan_alias" value="{{ old('jurusan_alias') }}"
                    ...
                    <div class="row">
                        <div class="form-group col-12">
                            ...
                            is-invalid
                        @enderror"
                                name="jurusan_code" id="jurusan_code" placeholder="Enter code">
