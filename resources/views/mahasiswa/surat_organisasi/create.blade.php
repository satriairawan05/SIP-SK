...
@section('app')
    ...
    <div class="row mb-3">
        ...
        @if (session('failed'))
            ...
            @endif
            <div class="card-body">
                <form action="{{ route('skos.store') }}" method="post">
                    @csrf
                    <div class="row mb-3">
                        <div class="col-6">
                            ...
                            is-invalid
                        @enderror"
                                name="sko_subject" id="sko_subject" value="{{ old('sko_subject') }}"
                    ...
                    {{-- <div class="row mb-3">
                        <div class="col-6">
                            ...
                            <textarea class="ckeditor form-control" name="sko_menimbang" id="sko_menimbang" cols="50" rows="10">{{ old('sko_menimbang') }}</textarea>
                            @error('sko_menimbang')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="col-6">
                            ...
                            <textarea class="ckeditor form-control" name="sko_mengingat" id="sko_mengingat" cols="50" rows="10">{{ old('sko_mengingat') }}</textarea>
                            @error('sko_mengingat')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-6">
                            ...
                            <textarea class="ckeditor form-control" name="sko_memperhatikan" id="sko_memperhatikan" cols="50" rows="10">{{ old('sko_memperhatikan') }}</textarea>
                        ...
                        <div class="col-6">
                            ...
                            <textarea class="ckeditor form-control" name="sko_menetapkan" id="sko_menetapkan" cols="50" rows="10">{{ old('sko_menetapkan') }}</textarea>
                    ...
                    <div class="row mb-3">
                        <div class="col-6">
                            ...
                            <textarea class="ckeditor form-control" name="sko_kesatu" id="sko_kesatu" cols="50" rows="10">{{ old('sko_kesatu') }}</textarea>
                            @error('sko_kesatu')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="col-6">
                            ...
                            <textarea class="ckeditor form-control" name="sko_kedua" id="sko_kedua" cols="50" rows="10">{{ old('sko_kedua') }}</textarea>
                            @error('sko_kedua')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-6">
                            ...
                            <textarea class="ckeditor form-control" name="sko_ketiga" id="sko_ketiga" cols="50" rows="10">{{ old('sko_ketiga') }}</textarea>
                            @error('sko_ketiga')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="col-6">
                            ...
                            <textarea class="ckeditor form-control" name="sko_keempat" id="sko_keempat" cols="50" rows="10">{{ old('sko_keempat') }}</textarea>
                            @error('sko_keempat')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-6">
                            ...
                            <textarea class="ckeditor form-control" name="sko_kelima" id="sko_kelima" cols="50" rows="10">{{ old('sko_kelima') }}</textarea>
                            @error('sko_kelima')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="col-6">
                            ...
                            <textarea class="ckeditor form-control" name="sko_tembusan" id="sko_tembusan" cols="50" rows="10">{{ old('sko_tembusan') }}</textarea>
                        </div>
                    </div> --}}
                    <div class="row">
