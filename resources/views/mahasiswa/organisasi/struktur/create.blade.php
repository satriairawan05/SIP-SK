...
@section('app')
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{ route('struktur_organisasis.index') }}">{{ $name }}</a></li>
    ...
    <div class="row mb-3">
        <div class="card col-12">
            ...
            @endif
            <div class="card-body">
                <form action="{{ route('struktur_organisasis.store') }}" method="post">
                    @csrf
                    <div class="row mb-3">
                        <div class="col-12">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-6">
                            ...
                            is-invalid
                        @enderror"
                                name="so_departemen" id="so_departemen" value="{{ old('so_departemen') }}"
                    ...
                    <div class="row">
                        <div class="col-12 d-flex justify-content-center">
                            <a href="{{ route('struktur_organisasis.index') }}" class="btn btn-sm btn-info mx-2"><i
