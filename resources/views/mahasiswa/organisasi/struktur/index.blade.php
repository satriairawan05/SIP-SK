    ...
    <div class="row mb-3">
        <div class="card col-12">
            ...
            <div class="card-header d-flex justify-content-end">
                <a href="{{ route('struktur_organisasis.create') }}" class="btn btn-sm btn-success"><i
                    ...
                    <tbody>
                        @foreach ($organisasi as $org)
                            <tr>
                                ...
                                <td>
                                    {{-- Edit --}}
                                    <a href="{{ route('struktur_organisasis.edit', $org->so_id) }}"
                                        class="btn btn-sm btn-warning"><i class="fas fa-edit"></i></a>
                                    {{-- Edit --}}
                                    {{-- Delete --}}
                                    <form action="{{ route('struktur_organisasis.destroy', $org->so_id) }}" method="post"
                                        class="d-inline">
                                        @csrf
                                        @method('delete')
