...
@section('app')
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{ route('organisasis.index') }}">{{ $name }}</a></li>
                ...
                <form action="{{ route('organisasis.store') }}" method="post">
                    ...
                    <div class="row">
                        <div class="form-group col-6">
                            ...
                            is-invalid
                        @enderror"
                                name="organisasi_nama" id="organisasi_nama" value="{{ old('organisasi_nama') }}"
                        ...
                        <div class="form-group col-6">
                            ...
                            is-invalid
                        @enderror"
                                name="organisasi_status" id="organisasi_status" value="{{ old('organisasi_status') }}"
                    ...
                    <div class="row">
                        <div class="form-group col-6">
                            ...
                            is-invalid
                        @enderror"
                                name="organisasi_periode" id="organisasi_periode" value="{{ old('organisasi_periode') }}"
                    ...
                    <div class="row">
                        <div class="col-12 d-flex justify-content-center">
                            <a href="{{ route('organisasis.index') }}" class="btn btn-sm btn-info mx-2"><i
