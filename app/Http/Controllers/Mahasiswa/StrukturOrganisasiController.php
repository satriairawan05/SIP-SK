    ...
    public function index()
    {
        try {
            return view('mahasiswa.organisasi.struktur.index',[
                'name' => $this->name,
                'organisasi' => StrukturOrganisasi::leftJoin('organisasis','struktur_organisasis.organisasi_id','=','organisasis.organisasi_id')->latest('struktur_organisasis.created_at')->get()
            ]);
        ...
        try {
            ...
            if (!$validated->fails()) {
                StrukturOrganisasi::where('so_id', $strukturOrganisasi->so_id)->update([
                    'so_nama' => $request->input('so_nama'),
                    'so_jabatan' => $request->input('so_jabatan'),
                    'so_departemen' => $request->input('so_jabatan'),
                    'organisasi_id' => $request->input('organisasi_id'),
                ]);
